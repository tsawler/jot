...
[![Go Coverage](https://github.com/tsawler/jot/wiki/coverage.svg)](https://raw.githack.com/wiki/tsawler/jot/coverage.html)
...
This module uses [github.com/golang-jwt/jwt/v5](https://github.com/golang-jwt/jwt) for token generation and validation. It
